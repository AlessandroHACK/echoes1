    ...
    return ( 
      <div className=" w-full bg-beige-100/90 shadow-md dark:bg-zinc-700/20 rounded-md grid grid-cols-1 lg:grid-cols-3 lg:gap-x-10">
        <div className=" p-3 flex flex-col ">
          ...
          <div className="">
            <h2 className="mt-2 text-center text-md  text-ash-500 dark:text-beige-100">{artist.descripcion}</h2>
          </div>
        </div>
        <div className="p-3 mt-10 lg:mt-0 col-span-2 grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-y-5 gap-x-2">
