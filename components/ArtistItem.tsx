...
const AlbumItem: React.FC<ArtistItemProps> = ({
    ...
    return (
        <Link href={`/Vinilos/${dataArtist.id_artista}`}>
            <div className="my-10 rounded-xl bg-beige-700 dark:bg-chocolate-800 p-3 shadow-gray-900 dark:shadow-chocolate-100 hover:shadow-2xl dark:shadow-md hover:transform hover:scale-105 duration-300 h-auto">
