...
const ArtistItem: React.FC<ArtistItemProps> = ({
    ...
    return (
        <Link href={`/Artistas/${dataArtist.id_artista}`}>
            <div className="my-10 rounded-xl bg-beige-100/60 dark:bg-chocolate-800 p-3 shadow-gray-400 dark:shadow-zinc-950 hover:transform hover:scale-105 duration-300 shadow-md h-auto">
